...
def ParseCmdLine():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="CCM random library with replacement: " + "(False default).",
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="CCM: Include Data from each model: " + "(False default).",
    )
