...
if __name__ == "__main__":
    ...
    half_life_seq_len_range = range(1, 300, 2)
    ...
    for no in neuron_range:
        ...
        for half_seq_len in half_life_seq_len_range:
            ...
            for length in range(1, residual.shape[0] - 1):
                input_group = []
                target_group = []
    ...
    plt.title("alpha - half_seq_len_range")
    plt.xlabel("half_seq_len_range, epoch = 100")
